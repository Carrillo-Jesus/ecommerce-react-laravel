...
export default function SelectImages({ updateImages, product }: { updateImages: (value: File[]) => void; product: Demo.Product }) {
    ...
    const onTemplateRemove = (file: File, callback: Function) => {
        ...
        const filteredImages = images.filter(img => img.name !== file.name) 
        ...
        return (
            <div className="flex align-items-center flex-column">
                ...
                <span style={{ fontSize: '1.2em', color: 'var(--text-color-secondary)' }} className="my-5">
                        Arrastra y suelta las imagenes del producto aquí
                </span>
            </div>
        );
    };
    ...
    return (
        <div className='w-100'>
            ...
            <FileUpload ref={fileUploadRef} name="demo[]" url="/api/upload" multiple accept="image/*" maxFileSize={3000000}
